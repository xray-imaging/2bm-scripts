...
/net/s2dserv/xorApps/epics/synApps_6_2_1/ioc/2bmSP2/iocBoot/ioc2bmSP2/softioc/2bmSP2.sh stop; \
sleep 1; \
/net/s2dserv/xorApps/epics/synApps_6_2_1/ioc/2bmSP2/iocBoot/ioc2bmSP2/softioc/2bmSP2.sh  start; \
sleep 1; \
